...
#if ! defined( STL_TRIM_WCHAR_HEADER_FILE )

#define STL_TRIM_WCHAR_HEADER_FILE
...
inline constexpr [[nodiscard]] std::wstring_view trim_left_view(_In_ std::wstring_view the_string) noexcept
{
    auto const string_length{ the_string.length() };
...
inline constexpr [[nodiscard]] std::wstring_view trim_left_view(_In_ std::wstring_view s, _In_ wchar_t const character) noexcept
{
    auto const string_length{ s.length() };
...
inline constexpr [[nodiscard]] std::wstring_view trim_right_view(_In_ std::wstring_view the_string) noexcept
{
    if (the_string.empty() == false)
    {
...
inline constexpr [[nodiscard]] std::wstring_view trim_view(_In_ std::wstring_view the_string) noexcept
{
    return(trim_left_view(trim_right_view(the_string)));
}

#endif // STL_TRIM_WCHAR_HEADER_FILE
