...
if exist "%ProgramFiles(x86)%\Microsoft Visual Studio\2019\Community\Common7\IDE\devenv.exe" set VisualStudioVersion=16.0
if exist "%ProgramFiles(x86)%\Microsoft Visual Studio\2019\Professional\Common7\IDE\devenv.exe" set VisualStudioVersion=16.1
:vsversionset

rem by default pick msbuild based on VisualStudioVersion
set _msbuildexe="%ProgramFiles(x86)%\MSBuild\14.0\Bin\MSBuild.exe"
if "%VisualStudioVersion%" == "16.1" set _msbuildexe="%ProgramFiles(x86)%\Microsoft Visual Studio\2019\Professional\MSBuild\Current\Bin\amd64\MSBuild.exe"
if "%VisualStudioVersion%" == "16.0" set _msbuildexe="%ProgramFiles(x86)%\Microsoft Visual Studio\2019\Community\MSBuild\Current\Bin\amd64\MSBuild.exe"
...
if not exist %_msbuildexe% set _msbuildexe="%ProgramFiles(x86)%\Microsoft Visual Studio\2019\Community\MSBuild\Current\Bin\amd64\MSBuild.exe""
...
%_msbuildexe% /t:compile /maxcpucount:%NUMBER_OF_PROCESSORS% WFC.Build
