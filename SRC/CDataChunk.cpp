...
<DT><PRE>std::vector&lt;uint8_t&gt; <B>Data</B></PRE><DD>
...
<H2>Methods</H2>
<DL COMPACT>
<DT><PRE>inline void <B><A NAME="Copy">Copy</A></B>( const CDataChunk&amp; source )</PRE><DD>
Copies the contents of another <B>CDataChunk</B> into this one.
<DT><PRE>inline void <B>Copy</B>( DWORD identifier, const std::vector&lt;uint8_t&gt;&amp; payload )</PRE><DD>
Sets the <B>Identifier</B> to <CODE>identifier</CODE> and copies the
<CODE>payload</CODE> into <B>Payload</B>.
<DT><PRE>static void <B><A NAME="GetIdentifier">GetIdentifier</A></B>( DWORD identifier, CString&amp; string )</PRE><DD>
...
<H2>Example</H2>
<PRE><CODE>void send_SLVL_chunk( const std::vector&lt;uint8_t&gt;&amp; data, <A HREF="CDataSocket.htm">CDataSocket</A>&amp; socket )
{
